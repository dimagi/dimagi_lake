...
KAFKA_OFFSET_PATH = f'hdfs://{HADOOP_SERVER_HOST}:{HADOOP_SERVER_PORT}/{HDFS_KAFKA_OFFSET_TABLE_DIR}'
HQ_DATA_PATH = f'hdfs://{HADOOP_SERVER_HOST}:{HADOOP_SERVER_PORT}/{HDFS_HQ_DATA_TABLE_DIR}'
DATABASE_SETTINGS = {
