...
DASHBOARD_DB_HOST = os.getenv('METASTORE_PASSWORD', 'localhost')
DASHBOARD_DB_PORT = os.getenv('METASTORE_PASSWORD', '5432')
DASHBOARD_DB_NAME = os.getenv('METASTORE_PASSWORD', 'mh_warehouse')
DASHBOARD_DB_USERNAME = os.getenv('METASTORE_PASSWORD', 'commcarehq')
DASHBOARD_DB_PASSWORD = os.getenv('METASTORE_PASSWORD', 'commcarehq')
